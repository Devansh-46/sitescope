      ...
      <nav className="border-b border-border bg-panel/80 backdrop-blur-sm sticky top-0 z-20">
        <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
          <a href="/" className="flex items-center gap-2 font-display font-bold text-lg">
            <span className="text-text-primary">Site</span><span className="text-signal">Scope</span>
          </a>
          <span className="text-xs font-mono text-text-muted border border-border px-3 py-1 rounded-full">AUDIT COMPLETE</span>
        </div>
      </nav>
      ...
      <div className="max-w-7xl mx-auto px-4 md:px-6 py-8 space-y-8">
        ...
        <div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {(Object.entries(audit.sections) as [string, typeof audit.sections.UX][]).map(([name, section], i) => (
